...
<body>
    ...
    <div class="container my-4">
        ...
        <h6 class="text-uppercase text-secondary mb-3" id="tituloGraficas"><i class="fas fa-chart-bar me-2"></i>Estadísticas históricas</h6>
        ...
        <h6 class="text-uppercase text-secondary mb-3" id="tituloEstadisticas"><i class="fas fa-chart-line me-2"></i>Datos recientes</h6>
...
<div class="mb-3">
    <h6 class="text-uppercase text-secondary mb-2"><i class="fas fa-table me-2"></i>Histórico de datos</h6>
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
    <div class="d-flex flex-wrap gap-2 align-items-center">
        <input type="date" id="fechaInicio" class="form-control form-control-sm" style="width:auto" onchange="filtrarTabla()">
        <span class="text-secondary">—</span>
        <input type="date" id="fechaFin" class="form-control form-control-sm" style="width:auto" onchange="filtrarTabla()">
