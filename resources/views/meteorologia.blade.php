...
<div class="container my-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="card p-3">
                <div class="card-header mb-3"><i class="fas fa-temperature-half me-2 text-danger"></i>Temperatura (°C)</div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="card p-3">
                <div class="card-header mb-3"><i class="fas fa-temperature-half me-2 text-danger"></i>Temperatura</div>
